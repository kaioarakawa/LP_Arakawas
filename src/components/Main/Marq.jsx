            ...
            <div className="main-marq">
              <div className="slide-har st1">
                <div className="box non-strok">
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Experiencia UI-UX</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Desenvolvimento Web</span> <span className="fz-50 ml-50 stroke icon">*</span></h4>
                  </div>
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Consultoria</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                  <div className="item">
                  ...
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Soluções Mobile</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                </div>
                <div className="box non-strok">
                  ...
                  <div className="item">
                    <h4 className="d-flex align-items-center"><span>Consulting</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                  <div className="item">
