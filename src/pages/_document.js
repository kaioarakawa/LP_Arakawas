  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta name="keywords" content="Arakawas Landing Page" />
        <meta name="description" content="Landing Page for Arakawas Enterprise" />
        <meta name="author" content="" />
        {/* ------ Favicon ------ */}
        <link rel="shortcut icon" href="/dark/assets/imgs/Icone_Preto_Fundo_Transparente.png" />
        {/* ------ Google Fonts ------ */}
